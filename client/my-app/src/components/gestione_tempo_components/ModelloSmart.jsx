        ...
        <div className={`accordion-item ${openAccordion.smart ? 'active' : ''}`} id="accordion-smart">
          ...
          <div className="accordion-content">
            <div className="accordion-inner">
              ...
              <form action="#" method="POST" className="smart-form">
                ...
                <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                  ...
                  <textarea id="smart_s" name="smart_s" rows="2" style={{ width: '100%', padding: '0.8rem', border: '1px solid #cbd5e0', borderRadius: '8px', fontFamily: 'var(--font-family)' }} placeholder="Es: Voglio studiare tutti i muscoli dell'arto superiore..."></textarea>
                </div>

                <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                  <label htmlFor="smart_m" style={{ display: 'block', fontWeight: '600', color: 'var(--text-color)', marginBottom: '0.5rem' }}>M - Misurabile</label>
                  <textarea id="smart_m" name="smart_m" rows="2" style={{ width: '100%', padding: '0.8rem', border: '1px solid #cbd5e0', borderRadius: '8px', fontFamily: 'var(--font-family)' }} placeholder="Es: Capirò di avercela fatta quando saprò ripetere origine e inserzione di ogni muscolo senza guardare il libro."></textarea>
                </div>

                <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                  <label htmlFor="smart_a" style={{ display: 'block', fontWeight: '600', color: 'var(--text-color)', marginBottom: '0.5rem' }}>A - Raggiungibile</label>
                  <textarea id="smart_a" name="smart_a" rows="2" style={{ width: '100%', padding: '0.8rem', border: '1px solid #cbd5e0', borderRadius: '8px', fontFamily: 'var(--font-family)' }} placeholder="Es: Sì, ho gli appunti completi e dedicherò 2 ore al giorno allo studio."></textarea>
                </div>

                <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                  <label htmlFor="smart_r" style={{ display: 'block', fontWeight: '600', color: 'var(--text-color)', marginBottom: '0.5rem' }}>R - Rilevante</label>
                  <textarea id="smart_r" name="smart_r" rows="2" style={{ width: '100%', padding: '0.8rem', border: '1px solid #cbd5e0', borderRadius: '8px', fontFamily: 'var(--font-family)' }} placeholder="Es: È fondamentale per poter passare l'esame di Anatomia questo semestre."></textarea>
                </div>

                <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                  <label htmlFor="smart_t" style={{ display: 'block', fontWeight: '600', color: 'var(--text-color)', marginBottom: '0.5rem' }}>T - Temporizzato</label>
                  <textarea id="smart_t" name="smart_t" rows="2" style={{ width: '100%', padding: '0.8rem', border: '1px solid #cbd5e0', borderRadius: '8px', fontFamily: 'var(--font-family)' }} placeholder="Es: Entro venerdì 15 alle ore 18:00."></textarea>
                </div>

                <div className="form-actions" style={{ marginTop: '2rem', textAlign: 'right' }}>
                  <button type="submit" className="btn btn-primary" style={{ backgroundColor: '#ed8936', border: 'none' }}>Salva il tuo Obiettivo</button>
                </div>
              </form>
            </div>
          </div>
