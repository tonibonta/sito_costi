  ...
  return (
    <>
      ...
      <section className="info-section">
        ...
        <p>
          «Abilità intra ed inter personali di tipo socio emotivo importanti per lo sviluppo personale, la partecipazione sociale e il successo lavorativo [...]» (Kechagias, 2011)
        </p>
      </section>
