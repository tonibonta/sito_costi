   ...
   <div style={{
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <h3 style={{ color: 'var(--primary-dark)', fontSize: '1.4rem', margin: 0 }}>
                Attribuzione causale interna in caso di successo/insuccesso
              </h3>
            </div>
            <span style={{ 
              fontSize: '1.8rem', 
          ...
          <div style={{
            ...
            <div style={{ overflow: 'hidden', minHeight: 0 }}>
              ...
              {/* Box interno con padding */}
              <div style={{ padding: '2rem' }}>
                {categoria.filter(val=>val.tipo==="dal_negativo_al_positivo").map(val=>{
                    return  <Negativopositivo key={val.id} val={val} handleDelete={handleDelete}/>
                })}
